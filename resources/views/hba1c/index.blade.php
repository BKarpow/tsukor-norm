                        ...
                        <div class="table-responsive">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="mt-1 d-flex justify-content-beetwen flex-wrap">
                                                    <a class="m-1 btn btn-dark btn-sm" href="{{route('hba1c.edit', ['hbA1c' => $hb])}}">
                                                        Редагувати
                                                    </a>
                                                    <delete-btn
                                                        delete-url="{{route('hba1c.delete', ['hbA1c' => $hb])}}">
                            ...
                            @if ($hba1cs->count() == 0)
                                <div class="alert alert-info">
                                    Поки немає жодного запису про Ваш рівень глікованого гемоглобіну, <a href="{{route('hba1c.create')}}">створити новий</a>.
                                </div>
                                <!-- /.alert alert-info -->
                            @endif
                        </div>

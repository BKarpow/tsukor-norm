    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="{{route('home')}}">Трекер діабету</a></li>
              ...
              @auth
                <li><a  href="{{ route('sugar.add') }}">+ Глюкоза крові</a></li>
                    <li>
                        ...
                        document.getElementById('logout-form').submit();"> Вийти
                        </a>
                    </li>
          ...
          <li>
            <a title="Запишіть показник глюкометра на сторінці за цим посиланням" class="getstarted scrollto" href="{{ route('sugar.add') }}">
                Записати цукор
            </a>
          </li>
